...
const expanded800 = ({ isDarkMode, activeLanguage }) => (
...
const expanded801 = ({ isDarkMode, activeLanguage }) => {
  return (
    <View
      style={{
    ...
    >
      ...
      <View style={styles.indentedTextContainer}>
        ...
        >
          ...
          fairness. Often a logical extension of the closest existing rule or
          the principles embodied in these rules will provide guidance for
      ...
      <View style={styles.indentedTextContainer}>
        ...
        >
          ...
          for the purpose of verifying scores and ensuring play in accordance
          with the rules. Any determination made by the group as a whole is to
          be made by a majority of the group.
        </Text>
      </View>
      <View style={styles.indentedTextContainer}>
        <Text
        ...
        >
          Players are expected to call a violation when one has clearly
          occurred. A call must be made promptly to be enforceable (except for
          misplays).
        </Text>
      </View>
      <View style={styles.indentedTextContainer}>
      ...
      <View style={styles.indentedTextContainer}>
        ...
        >
          ...
          is the initial advisement a player is given for violating certain
          rules; subsequent violations of the rule incur penalty throws. A call
          for a rules violation that results in a warning does not need to be
          confirmed to be enforced. Warnings do not carry over from one round to
          the next, nor to a playoff.
        </Text>
      </View>
      <View style={styles.indentedTextContainer}>
        <Text
        ...
        >
          ...
          another player in the group or by a Tournament Official. A penalty
          throw is a throw added to a player's score for violating a rule, or
          for relocation of the lie as called for by a rule.
        </Text>
      </View>
      <View style={styles.indentedTextContainer}>
        <Text
        ...
        >
          ...
          does not need to be confirmed to be enforced. An Official who is
          playing may not act as an Official for players who are in their
          division.
        </Text>
      </View>
      <View style={styles.indentedTextContainer}>
        ...
        >
          ...
          is the person in charge of the tournament or event. The Director may
          be a Tournament Director (TD), a Course Director, or a League
          Director. Only the Director may disqualify a player. Decisions made by
          the Director are final.
        </Text>
      </View>
      <View style={styles.indentedTextContainer}>
        <Text
        ...
        >
          A throw or an action that is subject to penalty under more than one
          rule is played under the rule that results in the most penalty throws;
          or, among rules that call for an equal number of penalty throws, the
          rule that was first violated.
        </Text>
      </View>
      <View style={styles.spacer} />
      ...
      <View style={styles.indentedTextContainer}>
        ...
        >
          ...
          decision to the Director, by clearly and promptly stating that desire
          to the group. If an Official or the Director is readily available, the
      ...
      <View style={styles.indentedTextContainer}>
        ...
        >
          ...
          make a set of provisional throws for each additional possible outcome
          of the ruling, and later appeal the ruling to an Official or to the
...
const expanded802 = ({ isDarkMode, activeLanguage }) => (
  <View
    style={{
      ...styles.expandedSectionContainer,
      ...styles.indentedSectionContainer,
...
const expanded803 = ({ isDarkMode, activeLanguage }) => (
  <View
    style={{
      ...styles.expandedSectionContainer,
      ...styles.indentedSectionContainer,
...
const expanded804 = ({ isDarkMode, activeLanguage }) => (
  <View
    style={{
      ...styles.expandedSectionContainer,
      ...styles.indentedSectionContainer,
